// vistas/vistaDetalleEleccion.js
 ...
 */
export async function vistaDetalleEleccion(container, idEleccion) {
    let destruida = false;
  ...
  `;
    ...
    btnVolver.addEventListener('click', () => navegarA('/v/panel'));
    ...
    const estado = obtenerEstadoEleccion(eleccion);
    ...
    // fechas parseadas
    const inicioReg = parsearFechaHora(eleccion.fechaInicioRegistro).toLocaleString();
    const finReg = parsearFechaHora(eleccion.fechaFinRegistro).toLocaleString();
    const inicioVot = parsearFechaHora(eleccion.fechaInicioVotacion).toLocaleString();
    const finVot = parsearFechaHora(eleccion.fechaFinVotacion).toLocaleString();
    const escru = parsearFechaHora(eleccion.fechaEscrutinio).toLocaleString();
